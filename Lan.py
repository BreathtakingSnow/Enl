...
class GameLauncher(QWidget):
    def __init__(self):
        ...
        self.title_bar.setStyleSheet("color: #ffffff;")
        ...
        list_label.setStyleSheet("font-size: 16px; font-weight: bold; color: #b0b0b0;")
        ...
        details_label.setStyleSheet("font-size: 16px; font-weight: bold; color: #b0b0b0;")
